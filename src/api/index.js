...
// 分页获取消息数据
export const getDataMessage = (params) => {
    return getRequest('/dm/getAllByPage', params)
}
export const addDeliveryPlatform = (params) => {
    return postRequest('/dm/add', params)
}
export const editDeliveryPlatform = (params) => {
    return postRequest('/dm/edit', params)
}
// 删除发送消息
export const deleteDeliveryPlatform = (ids, params) => {
    return deleteRequest(`/dm/delByIds/${ids}`, params)
}

// 客户数据导入
export const uploadFileLocal = "/api/dm/fileLocal";


// 分页获取消息数据
export const getAccountChannel = (params) => {
    return getRequest('/dm/acm/getAllByPage', params)
}

export const addAccountChannel = (params) => {
    return postRequest('/dm/acm/addAccountChannel', params)
}

export const editAccountChannel = (params) => {
    return postRequest('/dm/acm/edit', params)
}

export const deleteAccount = (ids, params) => {
    return deleteRequest(`/dm/acm/delByIds/${ids}`, params)
}

export const addKpi = (params) => {
    return postRequest('/dm/kpi/add', params)
}

export const getKpiList = (params) => {
    return getRequest('/dm/kpi/get', params)
}

export const saveKpi  = (params) => {
    return postRequest('/dm/acm/saveKpi', params)
}
